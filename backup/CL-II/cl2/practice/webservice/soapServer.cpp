...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.7.9l 2012-04-24 10:36:12 GMT")
...
{	struct ns__add soap_tmp_ns__add;
	...
	soap_tmp_ns__addResponse.c = &soap_tmp_double;
...
{	struct ns__sub soap_tmp_ns__sub;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns__subResponse.c = &soap_tmp_double;
