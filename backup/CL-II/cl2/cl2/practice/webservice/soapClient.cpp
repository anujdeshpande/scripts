...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.7.9l 2012-04-24 10:36:12 GMT")
...
{	struct ns__add soap_tmp_ns__add;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (c && soap_tmp_ns__addResponse->c)
...
{	struct ns__sub soap_tmp_ns__sub;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap_closesock(soap);
	if (c && soap_tmp_ns__subResponse->c)
