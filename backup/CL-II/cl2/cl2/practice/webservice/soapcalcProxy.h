	...
	{ soap = soap_new(); endpoint = "localhost:8000"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual int ns__add(double a, double b, double *c) { return soap ? soap_call_ns__add(soap, endpoint, NULL, a, b, c) : SOAP_EOM; };
	/// Invoke 'sub' of service 'calc' and return error code (or SOAP_OK)
	virtual int ns__sub(double a, double b, double *c) { return soap ? soap_call_ns__sub(soap, endpoint, NULL, a, b, c) : SOAP_EOM; };
};
#endif
